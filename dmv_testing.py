...
ESC_GPIO = 4 # Variable that stores GPIO pin number where ESC is connected
pi.set_mode(ESC_GPIO, pigpio.INPUT) # Sets ESC_GPIO as an input

pi.set_servo_pulsewidth(ESC_GPIO, 0) # Testing a PWM of 1500us on ESC (currently not working)
sleep(1)
